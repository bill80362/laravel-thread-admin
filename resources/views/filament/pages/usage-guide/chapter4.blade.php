<div class="space-y-4">
    ...
    <div class="flex items-start gap-3">
        ...
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">系統每 <strong>2 分鐘</strong> 自動檢查一次是否有新的回覆。新的回覆會自動出現在「回覆面板」頁面。</p>
        </div>
    </div>
    ...
    <div class="flex items-start gap-3">
        ...
        <div>
            ...
            <p class="text-gray-600 dark:text-gray-400 mt-1">在「回覆面板」頁面：點擊「新增貼文回覆」可直接回覆某篇貼文，或針對列表中的留言點擊「回應回覆」輸入內容送出，也可點擊「忽略」標記不需處理的回覆。</p>
            <p class="text-gray-600 dark:text-gray-400 mt-2">回覆發佈採用兩階段機制，建立後約 <strong>30 秒</strong> 才會顯示在 Threads 上。</p>
        </div>
    </div>
</div>
